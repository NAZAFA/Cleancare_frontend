...
function Footer() {
  ...
  <div className='flex md:justify-between  justify-center items-center flex-wrap  text-[#FFFFFFAB] md:px-8 px-3 container mx-auto py-10'>
     <div className='text-base font-normal text-left flex flex-wrap mb-4  md:mb-0'>
           <p className='me-8'><a href="#">For Home</a></p>
            <p className='me-8'><a href="#">Category</a></p>
            <p ><a href="#">Contact</a></p>
          </div>
      <p className='text-base'>copyright All Reservied @ Cleancare 2022-2023</p>
     </div>
  </div>
  </div>
  )
